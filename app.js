// Grab the result & start divs. Don't forget the document.getElementById('');:



// Grab the button using the getElementsByTagName. The S in elements IS important, fool:
...
var numbers = [
  ...
  191, 44, 206,ß 451, 141, 182, 320, 355, 402,
...
// Show the numbers in the startDiv using innerHTML to do so:
startDiv.innerHTML = numbers;

// Write a bubble sort function:
function sorter (nums) {

	// Loop through the array of numbers. You know how to do this. Stop freaking out.
  

		// ...and loop through them for each selected number. You are gonna need a new variable, stupit.
	...
	// Store the sorted results in the resultDiv using innerHTML:
